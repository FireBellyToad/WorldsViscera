...
use crate::{components::
    combat::{CombatStats, CanAutomaticallyHeal}, constants::MAX_STAMINA_HEAL_COUNTER}
;
...
impl AutomaticHealing {
    pub fn run(ecs_world: &mut World) {
        // Scope for keeping borrow checker quiet
        {
            ...
            let mut statted_entities = ecs_world.query::<(&mut CombatStats, &mut CanAutomaticallyHeal)>();
